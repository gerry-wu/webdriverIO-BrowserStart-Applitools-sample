  ...
  constructor(logger, other) {
    ...
    if (other) {
      ...
      for (const otherFrame of other.getFrames()) {
        this._frames.push(new Frame(logger, otherFrame.getReference(), otherFrame.getLocation(), otherFrame.getSize(), otherFrame.getInnerSize(), otherFrame.getOriginalLocation(), otherFrame.getOriginalOverflow()));
      }

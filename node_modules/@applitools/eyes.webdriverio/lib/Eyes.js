  ...
  async getScreenshot() {
    ...
    try {
      ...
      if (this._checkFrameOrElement) {
        ...
        const entireFrameOrElement = await algo.getStitchedRegion(this._imageProvider, this._regionToCheck, this._positionProvider, this.getElementPositionProvider(), scaleProviderFactory, this._cutProviderHandler.get(), this.getWaitBeforeScreenshots(), this._debugScreenshotsProvider, screenshotFactory, this.getStitchOverlap(), this._regionPositionCompensation);
        /*
        ...
        */
        ...
        const fullPageImage = await algo.getStitchedRegion(this._imageProvider, Region.EMPTY, new ScrollPositionProvider(this._logger, this._jsExecutor), this._positionProvider, scaleProviderFactory, this._cutProviderHandler.get(), this.getWaitBeforeScreenshots(), this._debugScreenshotsProvider, screenshotFactory, this.getStitchOverlap(), this._regionPositionCompensation);

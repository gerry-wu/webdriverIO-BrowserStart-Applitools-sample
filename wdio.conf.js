...
exports.config = {
    ...
    before: function (capabilities, specs) {
        ...
        var serverUrl = opt.protocol + '://' + user + ':' + key + '@' + opt.hostname + ':' + opt.port + '/wd/hub';
        driver = create_webdriver(serverUrl, browser.sessionId);
        ...
        browser.addCommand("EyesOpen", function (testName) {
            ...
            eyes.open(driver, "Applitools.com", testName);
        });
